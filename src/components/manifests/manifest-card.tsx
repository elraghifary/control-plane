...
import { FileStack, Calendar, Clock } from "lucide-react";
...
export function ManifestCard({ doc, onEdit }: { doc: ClickUpManifestPage; onEdit: () => void }) {
  return (
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0 flex-1 space-y-1.5">
          <div className="flex items-center gap-2">
            <FileStack className="h-4 w-4 shrink-0 text-instrument" />
            <a
              href={doc.htmlUrl}
              target="_blank"
              rel="noreferrer"
